...
const LockoutService = () => {
    ...
    const lockoutTypeOptions = [
        { value: '', label: 'Select Lockout Type', disabled: true },
        { value: 'Key Lost', label: 'Key Lost' },
        { value: 'Key in Car', label: 'Key in Car' }
    ];
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                <div className="text-center mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">
                        <span className="gradient-text">Lockout Service</span>
                    </h1>
                    <p className="text-gray-600 dark:text-text-muted text-lg max-w-2xl mx-auto">
                        Locked out of your vehicle? We'll connect you with verified locksmiths to help you regain access quickly and safely.
                    </p>
                </div>
