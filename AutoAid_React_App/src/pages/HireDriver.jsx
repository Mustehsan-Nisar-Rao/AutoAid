...
const HireDriver = () => {
    ...
    useEffect(() => {
        ...
        socket.on('new_job_message', (message) => {
            ...
            if (isChatOpen && message.senderId !== currentUser?.uid && activeJobRef.current) {
                socket.emit('mark_messages_seen', { requestId: activeJobRef.current._id, readerId: currentUser.uid });
            }
        });
